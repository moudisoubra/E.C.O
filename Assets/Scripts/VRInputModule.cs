...
public class VRInputModule : BaseInputModule
{
    ...
    {
        pointerData.Reset();
        pointerData.position = new Vector2(myCamera.pixelWidth / 2, myCamera.scaledPixelHeight / 2);
    ...
    {
        ExecuteEvents.Execute(data.pointerPress, pointerData, ExecuteEvents.pointerUpHandler);
